...
$(function () {
  ...
  */];
  ...
  for (const element of items) {
    const item = element;
    const html = '<div class="col-sm-4">' + '<a class="thumbnail add-item" model-name="' + item.name + '" model-url="' + item.model + '" model-type="' + item.type + '" model-is-table="' + item["is-table"] + '"><img class="img-fluid" src="' + item.image + '" alt="Add Item"> ' + item.name + '</a></div>';
    itemsDiv.append(html);
  }
});
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (module.exports);
})();
